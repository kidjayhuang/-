// pages/activity/published/published.js
...
Page({
  ...
  //     title: title,
  //     desc: desc,
  //     path: '/pages/activity/published/published'
  //   }
  // },
  initData: function() {
    var auth = app.globalData.auth;
  ...
  loadActivities: function () {
    var that = this;
    var url = "https://api.sca.programplus.cn/activity/my_create";
    var postData = {
      page: 1
    };
  ...
  loadNoticeCount: function () {
    var that = this;
    var url = "https://api.sca.programplus.cn/activity/notice_count";
    var postData = {};
    ...
    request.request(this, url, postData, function (data) {
      ...
      that.setData({ "message.unreadCount": count });
    }, function () {
