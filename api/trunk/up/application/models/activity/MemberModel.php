...
class MemberModel extends BaseModel
{
    ...
    public function member_list( $activity_id, $page=0 ){
        if( $page==0 ) {
            ...
            return $this->redis->zrevrange( REDIS_KEY_MEMBER . $activity_id, $start, $stop );
        }
    }
    ...
    public function my_join( $user_id ){
        return $this->redis->zrevrange( REDIS_KEY_MY_JOIN_ACTIVITY . $user_id, 0, LIMIT_JOIN_ACTIVITY );
    }
